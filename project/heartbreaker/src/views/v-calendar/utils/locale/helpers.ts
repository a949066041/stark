...
export const pageIsValid = (page: Page | null): boolean => !!(page && page.month && page.year);
...
export const pageIsBetweenPages = (page: Page, fromPage: Page, toPage: Page): boolean =>
  (page || false) && !pageIsBeforePage(page, fromPage) && !pageIsAfterPage(page, toPage);
