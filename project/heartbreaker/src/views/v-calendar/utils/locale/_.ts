/*
 * @Author: Rikka
 * @Date: 2022-12-01 22:08:15
 * @LastEditTime: 2022-12-23 19:03:02
 * @LastEditors: Rikka
 * @Description:
 * @FilePath: \stark\project\heartbreaker\src\views\v-calendar\utils\locale\_.ts
 */
// Type utils
...
export const isDate = (value: unknown) => _isDate(value) && !isNaN(value.getTime());
export const isObject = (value: unknown) => getType(value) === "Object";
// Object utils
export const has = _has;
export const hasAny = (obj: object, props: [string]) => _some(props, (p) => _has(obj, p));
// Collection utils
